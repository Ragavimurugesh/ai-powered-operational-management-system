...
function Notifications() {
  ...
  const [notifications, setNotifications] = useState([
    ...
    { id: 6, message: '💚 Health Score updated: 85% overall performance', type: 'success', time: '4 hours ago', read: true },
  ]);
      ...
      <div style={{ flex: 1, padding: '30px', overflowY: 'auto' }}>
        ...
        <div style={{
          ...
          {[
            ...
            { label: 'Unread', value: notifications.filter(n => !n.read).length, color: '#e74c3c' },
            { label: 'Read', value: notifications.filter(n => n.read).length, color: '#2ecc71' },
          ].map((card, i) => (
            <div key={i} style={{
